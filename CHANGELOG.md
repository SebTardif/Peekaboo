...
### Fixed
- MCP paste now warns without suggesting a retry when clipboard restoration fails after delivery, and reports the restoration outcome in metadata. Thanks @SebTardif for #210.
